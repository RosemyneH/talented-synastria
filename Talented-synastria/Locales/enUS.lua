...
L["Default Synastria perks and PerkOptions applied when importing builds/presets."] = true
L["Apply default Synastria perks with presets"] = true
L["When enabled, the toggles below run when you import a Synastria build/preset or SBM perk string (not on login). Only enables perks that are off; nothing is turned off."] = true
L["Perks (by ID)"] = true
L["When importing a build/preset, try to enable this perk if it is off (same click queue as build import)."] = true
...
L["Prestige (PerkOption)"] = true
L["Prestige: Attune Mastery — Excess Only"] = true
L["When importing a build/preset, runs ChangePerkOption(\"Prestige: Attune Mastery\", \"Excess Only\", true, false)."] = true